...
var script = {
  ...
  methods: {
    ...
    _loadScopedThemeStyles: function _loadScopedThemeStyles(preset) {
      ...
      var scopedStyle = (_this$$style11 = this.$style) === null || _this$$style11 === void 0 ? void 0 : _this$$style11.load(css3, _objectSpread({
...
import { mergeProps as mergeProps6, openBlock as openBlock5, createElementBlock as createElementBlock5 } from "vue";
...
var script9 = {
  ...
  computed: {
    attrs: function attrs() {
      return mergeProps6(this.ptmi("root", {
        context: {
          filled: this.$filled,
...
var BaseDirective = {
  ...
  _loadScopedThemeStyles: function _loadScopedThemeStyles2() {
    ...
    if (preset && instance.$attrSelector) {
      ...
      var scopedStyle = (_instance$$style12 = instance.$style) === null || _instance$$style12 === void 0 ? void 0 : _instance$$style12.load(css3, _objectSpread3({
...
var script12 = {
  ...
  methods: {
    ...
    onOptionSelect: function onOptionSelect(event, option2) {
      ...
      if (this.multiple) {
        ...
        if (!this.isSelected(option2)) {
          this.updateModel(event, [].concat(_toConsumableArray3(this.d_value || []), [value]));
        }
      } else {
    ...
    onEnterKey: function onEnterKey(event) {
      if (!this.typeahead) {
        if (this.multiple) {
          this.updateModel(event, [].concat(_toConsumableArray3(this.d_value || []), [event.target.value]));
          this.$refs.focusInput.value = "";
        }
      } else {
        if (!this.overlayVisible) {
...
function render8(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, null, 8, ["id", "name", "class", "style", "value", "placeholder", "tabindex", "fluid", "disabled", "size", "invalid", "variant", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant", "onFocus", "onBlur", "onKeydown", "onInput", "onChange", "unstyled", "pt"])) : createCommentVNode4("", true), _ctx.multiple ? (openBlock8(), createElementBlock7("ul", mergeProps9({
    key: 1,
    ref: "multiContainer",
  ...
  }, _ctx.ptm("inputMultiple")), [(openBlock8(true), createElementBlock7(Fragment2, null, renderList2(_ctx.d_value, function(option2, i) {
      ...
      return [createVNode2(Transition, mergeProps9({
        ...
        "default": withCtx(function() {
          return [$data.overlayVisible ? (openBlock8(), createElementBlock7("div", mergeProps9({
            ...
            style: _objectSpread5(_objectSpread5({}, _ctx.panelStyle), _ctx.overlayStyle),
          ...
          }), createElementVNode5("div", mergeProps9({
            "class": _ctx.cx("listContainer"),
            style: {
              "max-height": $options.virtualScrollerDisabled ? _ctx.scrollHeight : ""
            }
          }, _ctx.ptm("listContainer")), [createVNode2(_component_VirtualScroller, mergeProps9({
            ...
            content: withCtx(function(_ref) {
              ...
              }), 128)), _ctx.showEmptyMessage && (!items2 || items2 && items2.length === 0) ? (openBlock8(), createElementBlock7("li", mergeProps9({
                key: 0,
            ...
            key: "0"
          } : void 0]), 1040, ["style", "items", "disabled", "pt"])], 16), renderSlot4(_ctx.$slots, "footer", {
            value: _ctx.d_value,
            suggestions: $options.visibleOptions
          }), createElementVNode5("span", mergeProps9({
            role: "status",
